...
from artisan.vision.analysis.technique_analyzer import TechniqueAnalyzer
...
We want a nice, even coverage to work on."""
    ...
    def _analyze_layers(self) -> List[Dict]:
        ...
        from artisan.vision.analysis.simple_organic_segmentation import segment_into_painting_layers
